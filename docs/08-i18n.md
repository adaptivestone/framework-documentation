...
The `email.*` entries here are the subject lines and greeting of the recovery / verification emails, so overriding them changes what lands in the mailbox as well as what the API answers.
